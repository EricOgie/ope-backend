...
func StartApp() {
	...
	router.HandleFunc("/verify-account", authH.VerifyUserAcc).Methods(http.MethodPatch).Name("Verify-Acc")
	router.HandleFunc("/verifed", controllers.ServeHTMLTemplate).Methods(http.MethodGet).Name("Verified")
